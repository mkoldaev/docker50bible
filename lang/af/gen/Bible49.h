...
static void view1() {
struct af1 poems[] = {
	{1, "1 Paulus, 'n apostel van Jesus Christus deur die wil van God, aan die heiliges wat in Éfese is, en die gelowiges in Christus Jesus:"},
	{2, "2 Genade vir julle en vrede van God, onse Vader, en die Here Jesus Christus!"},
	{3, "3 Geseënd is die God en Vader van onse Here Jesus Christus wat ons geseën het met alle geestelike seëninge in die hemele in Christus,"},
...
struct af2 poems[] = {
	...
	{12, "12 dat julle in dié tyd sonder Christus was, vervreemd van die burgerskap van Israel en vreemdelinge ten aansien van die verbonde van die belofte, sonder hoop en sonder God in die wêreld."},
...
struct af4 poems[] = {
	...
	{9, "9 Maar dít: Hy het opgevaar--wat beteken dit anders as dat Hy ook eers neergedaal het in die onderste dele van die aarde?"},
...
struct af6 poems[] = {
	...
	{21, "21 En dat julle ook my omstandighede kan ken, hoe dit met my gaan, alles sal Tíchikus, die geliefde broeder en getroue dienaar in die Here, julle bekend maak."},
