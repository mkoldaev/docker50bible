...
struct fr1 poems[] = {
	...
	{13, "13 (1:12) lesquels sont nés, (1:13) non du sang, ni de la volonté de la chair, ni de la volonté de l'homme, mais de Dieu. "},
	...
	{21, "21 Et ils lui demandèrent: Quoi donc? es-tu Élie? Et il dit: Je ne le suis point. Es-tu le prophète? Et il répondit: Non. "},
	...
	{23, "23 Moi, dit-il, je suis la voix de celui qui crie dans le désert: Aplanissez le chemin du Seigneur, comme a dit Ésaïe, le prophète. "},
	{24, "24 Ceux qui avaient été envoyés étaient des pharisiens. "},
	{25, "25 Ils lui firent encore cette question: Pourquoi donc baptises-tu, si tu n'es pas le Christ, ni Élie, ni le prophète? "},
	{26, "26 Jean leur répondit: Moi, je baptise d'eau, mais au milieu de vous il y a quelqu'un que vous ne connaissez pas, "},
	{27, "27 (1:26) qui vient après moi; (1:27) je ne suis pas digne de délier la courroie de ses souliers. "},
...
struct fr2 poems[] = {
	...
	{22, "22 C'est pourquoi, lorsqu'il fut ressuscité des morts, ses disciples se souvinrent qu'il avait dit cela, et ils crurent à l'Écriture et à la parole que Jésus avait dite. "},
...
struct fr3 poems[] = {
	...
	{23, "23 Jean aussi baptisait à Énon, près de Salim, parce qu'il y avait là beaucoup d'eau; et on y venait pour être baptisé. "},
...
struct fr5 poems[] = {
	...
	{9, "9 Aussitôt cet homme fut guéri; il prit son lit, et marcha. (5:10) C'était un jour de sabbat. "},
	...
	{29, "29 (5:28) et en sortiront. (5:29) Ceux qui auront fait le bien ressusciteront pour la vie, mais ceux qui auront fait le mal ressusciteront pour le jugement. "},
	...
	{39, "39 Vous sondez les Écritures, parce que vous pensez avoir en elles la vie éternelle: ce sont elles qui rendent témoignage de moi. "},
...
struct fr6 poems[] = {
	...
	{17, "17 Étant montés dans une barque, ils traversaient la mer pour se rendre à Capernaüm. Il faisait déjà nuit, et Jésus ne les avait pas encore rejoints. "},
...
struct fr7 poems[] = {
	...
	{15, "15 Les Juifs s'étonnaient, disant: Comment connaît-il les Écritures, lui qui n'a point étudié? "},
	...
	{38, "38 Celui qui croit en moi, des fleuves d'eau vive couleront de son sein, comme dit l'Écriture. "},
	...
	{42, "42 L'Écriture ne dit-elle pas que c'est de la postérité de David, et du village de Bethléhem, où était David, que le Christ doit venir? "},
...
static void view8() {
struct fr8 poems[] = {
	{1, "1 Jésus se rendit à la montagne des oliviers. "},
	{2, "2 Mais, dès le matin, il alla de nouveau dans le temple, et tout le peuple vint à lui. S'étant assis, il les enseignait. "},
	{3, "3 Alors les scribes et les pharisiens amenèrent une femme surprise en adultère; (8:4) et, la plaçant au milieu du peuple, "},
	{4, "4 ils dirent à Jésus: Maître, cette femme a été surprise en flagrant délit d'adultère. "},
	{5, "5 Moïse, dans la loi, nous a ordonné de lapider de telles femmes: toi donc, que dis-tu? "},
	{6, "6 Ils disaient cela pour l'éprouver, afin de pouvoir l'accuser. Mais Jésus, s'étant baissé, écrivait avec le doigt sur la terre. "},
	{7, "7 Comme ils continuaient à l'interroger, il se releva et leur dit: Que celui de vous qui est sans péché jette le premier la pierre contre elle. "},
	{8, "8 Et s'étant de nouveau baissé, il écrivait sur la terre. "},
	{9, "9 Quand ils entendirent cela, accusés par leur conscience, ils se retirèrent un à un, depuis les plus âgés jusqu'aux derniers; et Jésus resta seul avec la femme qui était là au milieu. "},
	{10, "10 Alors s'étant relevé, et ne voyant plus que la femme, Jésus lui dit: Femme, où sont ceux qui t'accusaient? Personne ne t'a-t-il condamnée? "},
	{11, "11 Elle répondit: Non, Seigneur. Et Jésus lui dit: Je ne te condamne pas non plus: va, et ne pèche plus. "},
	{12, "12 Jésus leur parla de nouveau, et dit: Je suis la lumière du monde; celui qui me suit ne marchera pas dans les ténèbres, mais il aura la lumière de la vie. "},
	{13, "13 Là-dessus, les pharisiens lui dirent: Tu rends témoignage de toi-même; ton témoignage n'est pas vrai. "},
	{14, "14 Jésus leur répondit: Quoique je rende témoignage de moi-même, mon témoignage est vrai, car je sais d'où je suis venu et où je vais; mais vous, vous ne savez d'où je viens ni où je vais. "},
	{15, "15 Vous jugez selon la chair; moi, je ne juge personne. "},
	{16, "16 Et si je juge, mon jugement est vrai, car je ne suis pas seul; mais le Père qui m'a envoyé est avec moi. "},
	{17, "17 Il est écrit dans votre loi que le témoignage de deux hommes est vrai; "},
	{18, "18 je rends témoignage de moi-même, et le Père qui m'a envoyé rend témoignage de moi. "},
	{19, "19 Ils lui dirent donc: Où est ton Père? Jésus répondit: Vous ne connaissez ni moi, ni mon Père. Si vous me connaissiez, vous connaîtriez aussi mon Père. "},
	{20, "20 Jésus dit ces paroles, enseignant dans le temple, au lieu où était le trésor; et personne ne le saisit, parce que son heure n'était pas encore venue. "},
	{21, "21 Jésus leur dit encore: Je m'en vais, et vous me chercherez, et vous mourrez dans votre péché; vous ne pouvez venir où je vais. "},
	{22, "22 Sur quoi les Juifs dirent: Se tuera-t-il lui-même, puisqu'il dit: Vous ne pouvez venir où je vais? "},
	{23, "23 Et il leur dit: Vous êtes d'en bas; moi, je suis d'en haut. Vous êtes de ce monde; moi, je ne suis pas de ce monde. "},
	{24, "24 C'est pourquoi je vous ai dit que vous mourrez dans vos péchés; car si vous ne croyez pas ce que je suis, vous mourrez dans vos péchés. "},
	{25, "25 Qui es-tu? lui dirent-ils. Jésus leur répondit: Ce que je vous dis dès le commencement. "},
	{26, "26 J'ai beaucoup de choses à dire de vous et à juger en vous; mais celui qui m'a envoyé est vrai, et ce que j'ai entendu de lui, je le dis au monde. "},
	{27, "27 Ils ne comprirent point qu'il leur parlait du Père. "},
	{28, "28 Jésus donc leur dit: Quand vous aurez élevé le Fils de l'homme, alors vous connaîtrez ce que je suis, et que je ne fais rien de moi-même, mais que je parle selon ce que le Père m'a enseigné. "},
	{29, "29 Celui qui m'a envoyé est avec moi; il ne m'a pas laissé seul, parce que je fais toujours ce qui lui est agréable. "},
	{30, "30 Comme Jésus parlait ainsi, plusieurs crurent en lui. "},
	{31, "31 Et il dit aux Juifs qui avaient cru en lui: Si vous demeurez dans ma parole, vous êtes vraiment mes disciples; "},
	{32, "32 vous connaîtrez la vérité, et la vérité vous affranchira. "},
	{33, "33 Ils lui répondirent: Nous sommes la postérité d'Abraham, et nous ne fûmes jamais esclaves de personne; comment dis-tu: Vous deviendrez libres? "},
	{34, "34 En vérité, en vérité, je vous le dis, leur répliqua Jésus, quiconque se livre au péché est esclave du péché. "},
	{35, "35 Or, l'esclave ne demeure pas toujours dans la maison; le fils y demeure toujours. "},
	{36, "36 Si donc le Fils vous affranchit, vous serez réellement libres. "},
	{37, "37 Je sais que vous êtes la postérité d'Abraham; mais vous cherchez à me faire mourir, parce que ma parole ne pénètre pas en vous. "},
	{38, "38 Je dis ce que j'ai vu chez mon Père; et vous, vous faites ce que vous avez entendu de la part de votre père. "},
	{39, "39 Ils lui répondirent: Notre père, c'est Abraham. Jésus leur dit: Si vous étiez enfants d'Abraham, vous feriez les oeuvres d'Abraham. "},
	{40, "40 Mais maintenant vous cherchez à me faire mourir, moi qui vous ai dit la vérité que j'ai entendue de Dieu. Cela, Abraham ne l'a point fait. "},
	{41, "41 Vous faites les oeuvres de votre père. Ils lui dirent: Nous ne sommes pas des enfants illégitimes; nous avons un seul Père, Dieu. "},
	{42, "42 Jésus leur dit: Si Dieu était votre Père, vous m'aimeriez, car c'est de Dieu que je suis sorti et que je viens; je ne suis pas venu de moi-même, mais c'est lui qui m'a envoyé. "},
	{43, "43 Pourquoi ne comprenez-vous pas mon langage? Parce que vous ne pouvez écouter ma parole. "},
	{44, "44 Vous avez pour père le diable, et vous voulez accomplir les désirs de votre père. Il a été meurtrier dès le commencement, et il ne se tient pas dans la vérité, parce qu'il n'y a pas de vérité en lui. Lorsqu'il profère le mensonge, il parle de son propre fonds; car il est menteur et le père du mensonge. "},
	{45, "45 Et moi, parce que je dis la vérité, vous ne me croyez pas. "},
	{46, "46 Qui de vous me convaincra de péché? Si je dis la vérité, pourquoi ne me croyez-vous pas? "},
	{47, "47 Celui qui est de Dieu, écoute les paroles de Dieu; vous n'écoutez pas, parce que vous n'êtes pas de Dieu. "},
	{48, "48 Les Juifs lui répondirent: N'avons-nous pas raison de dire que tu es un Samaritain, et que tu as un démon? "},
	{49, "49 Jésus répliqua: Je n'ai point de démon; mais j'honore mon Père, et vous m'outragez. "},
	{50, "50 Je ne cherche point ma gloire; il en est un qui la cherche et qui juge. "},
	{51, "51 En vérité, en vérité, je vous le dis, si quelqu'un garde ma parole, il ne verra jamais la mort. "},
	{52, "52 Maintenant, lui dirent les Juifs, nous connaissons que tu as un démon. Abraham est mort, les prophètes aussi, et tu dis: Si quelqu'un garde ma parole, il ne verra jamais la mort. "},
	{53, "53 Es-tu plus grand que notre père Abraham, qui est mort? Les prophètes aussi sont morts. Qui prétends-tu être? "},
	{54, "54 Jésus répondit: Si je me glorifie moi-même, ma gloire n'est rien. C'est mon Père qui me glorifie, lui que vous dites être votre Dieu, "},
	{55, "55 et que vous ne connaissez pas. Pour moi, je le connais; et, si je disais que je ne le connais pas, je serais semblable à vous, un menteur. Mais je le connais, et je garde sa parole. "},
	{56, "56 Abraham, votre père, a tressailli de joie de ce qu'il verrait mon jour: il l'a vu, et il s'est réjoui. "},
	{57, "57 Les Juifs lui dirent: Tu n'as pas encore cinquante ans, et tu as vu Abraham! "},
	{58, "58 Jésus leur dit: En vérité, en vérité, je vous le dis, avant qu'Abraham fût, je suis. "},
	{59, "59 Là-dessus, ils prirent des pierres pour les jeter contre lui; mais Jésus se cacha, et il sortit du temple. "},
};
size_t npoems = sizeof poems / sizeof poems[0];size_t i;for (i=0; i < npoems; ++i) {printf("%s\n", poems[i].msg);}
}
static void view9() {
struct fr9 poems[] = {
	...
	{16, "16 Sur quoi quelques-uns des pharisiens dirent: Cet homme ne vient pas de Dieu, car il n'observe pas le sabbat. D'autres dirent: Comment un homme pécheur peut-il faire de tels miracles? (9:17) Et il y eut division parmi eux. "},
...
struct fr10 poems[] = {
	...
	{14, "14 (10:13) Je suis le bon berger. (10:14) Je connais mes brebis, et elles me connaissent, "},
	...
	{35, "35 Si elle a appelé dieux ceux à qui la parole de Dieu a été adressée, et si l'Écriture ne peut être anéantie, "},
...
struct fr11 poems[] = {
	...
	{54, "54 C'est pourquoi Jésus ne se montra plus ouvertement parmi les Juifs; mais il se retira dans la contrée voisine du désert, dans une ville appelée Éphraïm; et là il demeurait avec ses disciples. "},
...
struct fr12 poems[] = {
	...
	{38, "38 afin que s'accomplît la parole qu'Ésaïe, le prophète, a prononcée: Seigneur, Qui a cru à notre prédication? Et à qui le bras du Seigneur a-t-il été révélé? "},
	{39, "39 Aussi ne pouvaient-ils croire, parce qu'Ésaïe a dit encore: "},
	...
	{41, "41 Ésaïe dit ces choses, lorsqu'il vit sa gloire, et qu'il parla de lui. "},
...
struct fr13 poems[] = {
	...
	{18, "18 Ce n'est pas de vous tous que je parle; je connais ceux que j'ai choisis. Mais il faut que l'Écriture s'accomplisse: Celui qui mange avec moi le pain A levé son talon contre moi. "},
...
static void view14() {
struct fr14 poems[] = {
	{1, "1 Que votre coeur ne se trouble point. Croyez en Dieu, et croyez en moi. "},
	{2, "2 Il y a plusieurs demeures dans la maison de mon Père. Si cela n'était pas, je vous l'aurais dit. Je vais vous préparer une place. "},
	{3, "3 Et, lorsque je m'en serai allé, et que je vous aurai préparé une place, je reviendrai, et je vous prendrai avec moi, afin que là où je suis vous y soyez aussi. "},
	{4, "4 Vous savez où je vais, et vous en savez le chemin. "},
	{5, "5 Thomas lui dit: Seigneur, nous ne savons où tu vas; comment pouvons-nous en savoir le chemin? "},
	{6, "6 Jésus lui dit: Je suis le chemin, la vérité, et la vie. Nul ne vient au Père que par moi. "},
	{7, "7 Si vous me connaissiez, vous connaîtriez aussi mon Père. Et dès maintenant vous le connaissez, et vous l'avez vu. "},
	{8, "8 Philippe lui dit: Seigneur, montre-nous le Père, et cela nous suffit. "},
	{9, "9 Jésus lui dit: Il y a si longtemps que je suis avec vous, et tu ne m'as pas connu, Philippe! Celui qui m'a vu a vu le Père; comment dis-tu: Montre-nous le Père? "},
	{10, "10 Ne crois-tu pas que je suis dans le Père, et que le Père est en moi? Les paroles que je vous dis, je ne les dis pas de moi-même; et le Père qui demeure en moi, c'est lui qui fait les oeuvres. "},
	{11, "11 Croyez-moi, je suis dans le Père, et le Père est en moi; croyez du moins à cause de ces oeuvres. "},
	{12, "12 En vérité, en vérité, je vous le dis, celui qui croit en moi fera aussi les oeuvres que je fais, et il en fera de plus grandes, parce que je m'en vais au Père; "},
	{13, "13 et tout ce que vous demanderez en mon nom, je le ferai, afin que le Père soit glorifié dans le Fils. "},
	{14, "14 Si vous demandez quelque chose en mon nom, je le ferai. "},
	{15, "15 Si vous m'aimez, gardez mes commandements. "},
	{16, "16 Et moi, je prierai le Père, et il vous donnera un autre consolateur, afin qu'il demeure éternellement avec vous, "},
	{17, "17 l'Esprit de vérité, que le monde ne peut recevoir, parce qu'il ne le voit point et ne le connaît point; mais vous, vous le connaissez, car il demeure avec vous, et il sera en vous. "},
	{18, "18 Je ne vous laisserai pas orphelins, je viendrai à vous. "},
	{19, "19 Encore un peu de temps, et le monde ne me verra plus; mais vous, vous me verrez, car je vis, et vous vivrez aussi. "},
	{20, "20 En ce jour-là, vous connaîtrez que je suis en mon Père, que vous êtes en moi, et que je suis en vous. "},
	{21, "21 Celui qui a mes commandements et qui les garde, c'est celui qui m'aime; et celui qui m'aime sera aimé de mon Père, je l'aimerai, et je me ferai connaître à lui. "},
	{22, "22 Jude, non pas l'Iscariot, lui dit: Seigneur, d'où vient que tu te feras connaître à nous, et non au monde? "},
	{23, "23 Jésus lui répondit: Si quelqu'un m'aime, il gardera ma parole, et mon Père l'aimera; nous viendrons à lui, et nous ferons notre demeure chez lui. "},
	{24, "24 Celui qui ne m'aime pas ne garde point mes paroles. Et la parole que vous entendez n'est pas de moi, mais du Père qui m'a envoyé. "},
	{25, "25 Je vous ai dit ces choses pendant que je demeure avec vous. "},
	{26, "26 Mais le consolateur, l'Esprit-Saint, que le Père enverra en mon nom, vous enseignera toutes choses, et vous rappellera tout ce que je vous ai dit. "},
	{27, "27 Je vous laisse la paix, je vous donne ma paix. Je ne vous donne pas comme le monde donne. Que votre coeur ne se trouble point, et ne s'alarme point. "},
	{28, "28 Vous avez entendu que je vous ai dit: Je m'en vais, et je reviens vers vous. Si vous m'aimiez, vous vous réjouiriez de ce que je vais au Père; car le Père est plus grand que moi. "},
	{29, "29 Et maintenant je vous ai dit ces choses avant qu'elles arrivent, afin que, lorsqu'elles arriveront, vous croyiez. "},
	{30, "30 Je ne parlerai plus guère avec vous; car le prince du monde vient. Il n'a rien en moi; "},
	{31, "31 mais afin que le monde sache que j'aime le Père, et que j'agis selon l'ordre que le Père m'a donné, levez-vous, partons d'ici. "},
};
size_t npoems = sizeof poems / sizeof poems[0];size_t i;for (i=0; i < npoems; ++i) {printf("%s\n", poems[i].msg);}
}
static void view15() {
struct fr15 poems[] = {
	{1, "1 Je suis le vrai cep, et mon Père est le vigneron. "},
	{2, "2 Tout sarment qui est en moi et qui ne porte pas de fruit, il le retranche; et tout sarment qui porte du fruit, il l'émonde, afin qu'il porte encore plus de fruit. "},
	{3, "3 Déjà vous êtes purs, à cause de la parole que je vous ai annoncée. "},
	{4, "4 Demeurez en moi, et je demeurerai en vous. Comme le sarment ne peut de lui-même porter du fruit, s'il ne demeure attaché au cep, ainsi vous ne le pouvez non plus, si vous ne demeurez en moi. "},
	{5, "5 Je suis le cep, vous êtes les sarments. Celui qui demeure en moi et en qui je demeure porte beaucoup de fruit, car sans moi vous ne pouvez rien faire. "},
	{6, "6 Si quelqu'un ne demeure pas en moi, il est jeté dehors, comme le sarment, et il sèche; puis on ramasse les sarments, on les jette au feu, et ils brûlent. "},
	{7, "7 Si vous demeurez en moi, et que mes paroles demeurent en vous, demandez ce que vous voudrez, et cela vous sera accordé. "},
	{8, "8 Si vous portez beaucoup de fruit, c'est ainsi que mon Père sera glorifié, et que vous serez mes disciples. "},
	{9, "9 Comme le Père m'a aimé, je vous ai aussi aimés. Demeurez dans mon amour. "},
	{10, "10 Si vous gardez mes commandements, vous demeurerez dans mon amour, de même que j'ai gardé les commandements de mon Père, et que je demeure dans son amour. "},
	{11, "11 Je vous ai dit ces choses, afin que ma joie soit en vous, et que votre joie soit parfaite. "},
	{12, "12 C'est ici mon commandement: Aimez-vous les uns les autres, comme je vous ai aimés. "},
	{13, "13 Il n'y a pas de plus grand amour que de donner sa vie pour ses amis. "},
	{14, "14 Vous êtes mes amis, si vous faites ce que je vous commande. "},
	...
	{16, "16 Ce n'est pas vous qui m'avez choisi; mais moi, je vous ai choisis, et je vous ai établis, afin que vous alliez, et que vous portiez du fruit, et que votre fruit demeure, afin que ce que vous demanderez au Père en mon nom, il vous le donne. "},
	{17, "17 Ce que je vous commande, c'est de vous aimer les uns les autres. "},
	{18, "18 Si le monde vous hait, sachez qu'il m'a haï avant vous. "},
	{19, "19 Si vous étiez du monde, le monde aimerait ce qui est à lui; mais parce que vous n'êtes pas du monde, et que je vous ai choisis du milieu du monde, à cause de cela le monde vous hait. "},
	{20, "20 Souvenez-vous de la parole que je vous ai dite: Le serviteur n'est pas plus grand que son maître. S'ils m'ont persécuté, ils vous persécuteront aussi; s'ils ont gardé ma parole, ils garderont aussi la vôtre. "},
	{21, "21 Mais ils vous feront toutes ces choses à cause de mon nom, parce qu'ils ne connaissent pas celui qui m'a envoyé. "},
	{22, "22 Si je n'étais pas venu et que je ne leur eusse point parlé, ils n'auraient pas de péché; mais maintenant ils n'ont aucune excuse de leur péché. "},
	{23, "23 Celui qui me hait, hait aussi mon Père. "},
	{24, "24 Si je n'avais pas fait parmi eux des oeuvres que nul autre n'a faites, ils n'auraient pas de péché; mais maintenant ils les ont vues, et ils ont haï et moi et mon Père. "},
	{25, "25 Mais cela est arrivé afin que s'accomplît la parole qui est écrite dans leur loi: Ils m'ont haï sans cause. "},
	{26, "26 Quand sera venu le consolateur, que je vous enverrai de la part du Père, l'Esprit de vérité, qui vient du Père, il rendra témoignage de moi; "},
	{27, "27 et vous aussi, vous rendrez témoignage, parce que vous êtes avec moi dès le commencement. "},
};
size_t npoems = sizeof poems / sizeof poems[0];size_t i;for (i=0; i < npoems; ++i) {printf("%s\n", poems[i].msg);}
}
static void view16() {
struct fr16 poems[] = {
	{1, "1 Je vous ai dit ces choses, afin qu'elles ne soient pas pour vous une occasion de chute. "},
	{2, "2 Ils vous excluront des synagogues; et même l'heure vient où quiconque vous fera mourir croira rendre un culte à Dieu. "},
	{3, "3 Et ils agiront ainsi, parce qu'ils n'ont connu ni le Père ni moi. "},
	{4, "4 Je vous ai dit ces choses, afin que, lorsque l'heure sera venue, vous vous souveniez que je vous les ai dites. Je ne vous en ai pas parlé dès le commencement, parce que j'étais avec vous. "},
	{5, "5 Maintenant je m'en vais vers celui qui m'a envoyé, et aucun de vous ne me demande: Où vas-tu? "},
	{6, "6 Mais, parce que je vous ai dit ces choses, la tristesse a rempli votre coeur. "},
	{7, "7 Cependant je vous dis la vérité: il vous est avantageux que je m'en aille, car si je ne m'en vais pas, le consolateur ne viendra pas vers vous; mais, si je m'en vais, je vous l'enverrai. "},
	{8, "8 Et quand il sera venu, il convaincra le monde en ce qui concerne le péché, la justice, et le jugement: "},
	{9, "9 en ce qui concerne le péché, parce qu'ils ne croient pas en moi; "},
	{10, "10 la justice, parce que je vais au Père, et que vous ne me verrez plus; "},
	{11, "11 le jugement, parce que le prince de ce monde est jugé. "},
	{12, "12 J'ai encore beaucoup de choses à vous dire, mais vous ne pouvez pas les porter maintenant. "},
	{13, "13 Quand le consolateur sera venu, l'Esprit de vérité, il vous conduira dans toute la vérité; car il ne parlera pas de lui-même, mais il dira tout ce qu'il aura entendu, et il vous annoncera les choses à venir. "},
	{14, "14 Il me glorifiera, parce qu'il prendra de ce qui est à moi, et vous l'annoncera. "},
	{15, "15 Tout ce que le Père a est à moi; c'est pourquoi j'ai dit qu'il prend de ce qui est à moi, et qu'il vous l'annoncera. "},
	...
	{17, "17 Là-dessus, quelques-uns de ses disciples dirent entre eux: Que signifie ce qu'il nous dit: Encore un peu de temps, et vous ne me verrez plus; et puis encore un peu de temps, et vous me verrez? et: Parce que je vais au Père? "},
	{18, "18 Ils disaient donc: Que signifie ce qu'il dit: Encore un peu de temps? Nous ne savons de quoi il parle. "},
	{19, "19 Jésus, connut qu'ils voulaient l'interroger, leur dit: Vous vous questionnez les uns les autres sur ce que j'ai dit: Encore un peu de temps, et vous ne me verrez plus; et puis encore un peu de temps, et vous me verrez. "},
	{20, "20 En vérité, en vérité, je vous le dis, vous pleurerez et vous vous lamenterez, et le monde se réjouira: vous serez dans la tristesse, mais votre tristesse se changera en joie. "},
	{21, "21 La femme, lorsqu'elle enfante, éprouve de la tristesse, parce que son heure est venue; mais, lorsqu'elle a donné le jour à l'enfant, elle ne se souvient plus de la souffrance, à cause de la joie qu'elle a de ce qu'un homme est né dans le monde. "},
	{22, "22 Vous donc aussi, vous êtes maintenant dans la tristesse; mais je vous reverrai, et votre coeur se réjouira, et nul ne vous ravira votre joie. "},
	{23, "23 En ce jour-là, vous ne m'interrogerez plus sur rien. En vérité, en vérité, je vous le dis, ce que vous demanderez au Père, il vous le donnera en mon nom. "},
	{24, "24 Jusqu'à présent vous n'avez rien demandé en mon nom. Demandez, et vous recevrez, afin que votre joie soit parfaite. "},
	{25, "25 Je vous ai dit ces choses en paraboles. L'heure vient où je ne vous parlerai plus en paraboles, mais où je vous parlerai ouvertement du Père. "},
	{26, "26 En ce jour, vous demanderez en mon nom, et je ne vous dis pas que je prierai le Père pour vous; "},
	{27, "27 car le Père lui-même vous aime, parce que vous m'avez aimé, et que vous avez cru que je suis sorti de Dieu. "},
	{28, "28 Je suis sorti du Père, et je suis venu dans le monde; maintenant je quitte le monde, et je vais au Père. "},
	{29, "29 Ses disciples lui dirent: Voici, maintenant tu parles ouvertement, et tu n'emploies aucune parabole. "},
	{30, "30 Maintenant nous savons que tu sais toutes choses, et que tu n'as pas besoin que personne t'interroge; c'est pourquoi nous croyons que tu es sorti de Dieu. "},
	{31, "31 Jésus leur répondit: Vous croyez maintenant. "},
	{32, "32 Voici, l'heure vient, et elle est déjà venue, où vous serez dispersés chacun de son côté, et où vous me laisserez seul; mais je ne suis pas seul, car le Père est avec moi. "},
	{33, "33 Je vous ai dit ces choses, afin que vous ayez la paix en moi. Vous aurez des tribulations dans le monde; mais prenez courage, j'ai vaincu le monde. "},
};
size_t npoems = sizeof poems / sizeof poems[0];size_t i;for (i=0; i < npoems; ++i) {printf("%s\n", poems[i].msg);}
}
static void view17() {
struct fr17 poems[] = {
	...
	{12, "12 Lorsque j'étais avec eux dans le monde, je les gardais en ton nom. J'ai gardé ceux que tu m'as donnés, et aucun d'eux ne s'est perdu, sinon le fils de perdition, afin que l'Écriture fût accomplie. "},
...
static void view18() {
struct fr18 poems[] = {
	{1, "1 Lorsqu'il eut dit ces choses, Jésus alla avec ses disciples de l'autre côté du torrent du Cédron, où se trouvait un jardin, dans lequel il entra, lui et ses disciples. "},
	{2, "2 Judas, qui le livrait, connaissait ce lieu, parce que Jésus et ses disciples s'y étaient souvent réunis. "},
	{3, "3 Judas donc, ayant pris la cohorte, et des huissiers qu'envoyèrent les principaux sacrificateurs et les pharisiens, vint là avec des lanternes, des flambeaux et des armes. "},
	{4, "4 Jésus, sachant tout ce qui devait lui arriver, s'avança, et leur dit: Qui cherchez-vous? "},
	{5, "5 Ils lui répondirent: Jésus de Nazareth. Jésus leur dit: C'est moi. Et Judas, qui le livrait, était avec eux. "},
	{6, "6 Lorsque Jésus leur eut dit: C'est moi, ils reculèrent et tombèrent par terre. "},
	{7, "7 Il leur demanda de nouveau: Qui cherchez-vous? Et ils dirent: Jésus de Nazareth. "},
	{8, "8 Jésus répondit: Je vous ai dit que c'est moi. Si donc c'est moi que vous cherchez, laissez aller ceux-ci. "},
	{9, "9 Il dit cela, afin que s'accomplît la parole qu'il avait dite: Je n'ai perdu aucun de ceux que tu m'as donnés. "},
	{10, "10 Simon Pierre, qui avait une épée, la tira, frappa le serviteur du souverain sacrificateur, et lui coupa l'oreille droite. Ce serviteur s'appelait Malchus. "},
	{11, "11 Jésus dit à Pierre: Remets ton épée dans le fourreau. Ne boirai-je pas la coupe que le Père m'a donnée à boire? "},
	{12, "12 La cohorte, le tribun, et les huissiers des Juifs, se saisirent alors de Jésus, et le lièrent. "},
	{13, "13 Ils l'emmenèrent d'abord chez Anne; car il était le beau-père de Caïphe, qui était souverain sacrificateur cette année-là. "},
	{14, "14 Et Caïphe était celui qui avait donné ce conseil aux Juifs: Il est avantageux qu'un seul homme meure pour le peuple. "},
	{15, "15 Simon Pierre, avec un autre disciple, suivait Jésus. Ce disciple était connu du souverain sacrificateur, et il entra avec Jésus dans la cour du souverain sacrificateur; "},
	{16, "16 mais Pierre resta dehors près de la porte. L'autre disciple, qui était connu du souverain sacrificateur, sortit, parla à la portière, et fit entrer Pierre. "},
	{17, "17 Alors la servante, la portière, dit à Pierre: Toi aussi, n'es-tu pas des disciples de cet homme? Il dit: Je n'en suis point. "},
	...
	{19, "19 Le souverain sacrificateur interrogea Jésus sur ses disciples et sur sa doctrine. "},
	{20, "20 Jésus lui répondit: J'ai parlé ouvertement au monde; j'ai toujours enseigné dans la synagogue et dans le temple, où tous les Juifs s'assemblent, et je n'ai rien dit en secret. "},
	{21, "21 Pourquoi m'interroges-tu? Interroge sur ce que je leur ai dit ceux qui m'ont entendu; voici, ceux-là savent ce que j'ai dit. "},
	{22, "22 A ces mots, un des huissiers, qui se trouvait là, donna un soufflet à Jésus, en disant: Est-ce ainsi que tu réponds au souverain sacrificateur? "},
	{23, "23 Jésus lui dit: Si j'ai mal parlé, fais voir ce que j'ai dit de mal; et si j'ai bien parlé, pourquoi me frappes-tu? "},
	{24, "24 Anne l'envoya lié à Caïphe, le souverain sacrificateur. "},
	{25, "25 Simon Pierre était là, et se chauffait. On lui dit: Toi aussi, n'es-tu pas de ses disciples? Il le nia, et dit: Je n'en suis point. "},
	{26, "26 Un des serviteurs du souverain sacrificateur, parent de celui à qui Pierre avait coupé l'oreille, dit: Ne t'ai-je pas vu avec lui dans le jardin? "},
	{27, "27 Pierre le nia de nouveau. Et aussitôt le coq chanta. "},
	{28, "28 Ils conduisirent Jésus de chez Caïphe au prétoire: c'était le matin. Ils n'entrèrent point eux-mêmes dans le prétoire, afin de ne pas se souiller, et de pouvoir manger la Pâque. "},
	{29, "29 Pilate sortit donc pour aller à eux, et il dit: Quelle accusation portez-vous contre cet homme? "},
	{30, "30 Ils lui répondirent: Si ce n'était pas un malfaiteur, nous ne te l'aurions pas livré. "},
	{31, "31 Sur quoi Pilate leur dit: Prenez-le vous-mêmes, et jugez-le selon votre loi. Les Juifs lui dirent: Il ne nous est pas permis de mettre personne à mort. "},
	{32, "32 C'était afin que s'accomplît la parole que Jésus avait dite, lorsqu'il indiqua de quelle mort il devait mourir. "},
	{33, "33 Pilate rentra dans le prétoire, appela Jésus, et lui dit: Es-tu le roi des Juifs? "},
	{34, "34 Jésus répondit: Est-ce de toi-même que tu dis cela, ou d'autres te l'ont-ils dit de moi? "},
	{35, "35 Pilate répondit: Moi, suis-je Juif? Ta nation et les principaux sacrificateurs t'ont livré à moi: qu'as-tu fait? "},
	{36, "36 Mon royaume n'est pas de ce monde, répondit Jésus. Si mon royaume était de ce monde, mes serviteurs auraient combattu pour moi afin que je ne fusse pas livré aux Juifs; mais maintenant mon royaume n'est point d'ici-bas. "},
	{37, "37 Pilate lui dit: Tu es donc roi? Jésus répondit: Tu le dis, je suis roi. Je suis né et je suis venu dans le monde pour rendre témoignage à la vérité. Quiconque est de la vérité écoute ma voix. "},
	{38, "38 Pilate lui dit: Qu'est-ce que la vérité? Après avoir dit cela, il sortit de nouveau pour aller vers les Juifs, et il leur dit: Je ne trouve aucun crime en lui. "},
	{39, "39 Mais, comme c'est parmi vous une coutume que je vous relâche quelqu'un à la fête de Pâque, voulez-vous que je vous relâche le roi des Juifs? "},
	{40, "40 Alors de nouveau tous s'écrièrent: Non pas lui, mais Barabbas. Or, Barabbas était un brigand. "},
};
size_t npoems = sizeof poems / sizeof poems[0];size_t i;for (i=0; i < npoems; ++i) {printf("%s\n", poems[i].msg);}
}
static void view19() {
struct fr19 poems[] = {
	{1, "1 Alors Pilate prit Jésus, et le fit battre de verges. "},
	{2, "2 Les soldats tressèrent une couronne d'épines qu'ils posèrent sur sa tête, et ils le revêtirent d'un manteau de pourpre; puis, s'approchant de lui, "},
	{3, "3 ils disaient: Salut, roi des Juifs! Et ils lui donnaient des soufflets. "},
	{4, "4 Pilate sortit de nouveau, et dit aux Juifs: Voici, je vous l'amène dehors, afin que vous sachiez que je ne trouve en lui aucun crime. "},
	{5, "5 Jésus sortit donc, portant la couronne d'épines et le manteau de pourpre. Et Pilate leur dit: Voici l'homme. "},
	{6, "6 Lorsque les principaux sacrificateurs et les huissiers le virent, ils s'écrièrent: Crucifie! crucifie! Pilate leur dit: Prenez-le vous-mêmes, et crucifiez-le; car moi, je ne trouve point de crime en lui. "},
	{7, "7 Les Juifs lui répondirent: Nous avons une loi; et, selon notre loi, il doit mourir, parce qu'il s'est fait Fils de Dieu. "},
	{8, "8 Quand Pilate entendit cette parole, sa frayeur augmenta. "},
	{9, "9 Il rentra dans le prétoire, et il dit à Jésus: D'où es-tu? Mais Jésus ne lui donna point de réponse. "},
	{10, "10 Pilate lui dit: Est-ce à moi que tu ne parles pas? Ne sais-tu pas que j'ai le pouvoir de te crucifier, et que j'ai le pouvoir de te relâcher? "},
	{11, "11 Jésus répondit: Tu n'aurais sur moi aucun pouvoir, s'il ne t'avait été donné d'en haut. C'est pourquoi celui qui me livre à toi commet un plus grand péché. "},
	{12, "12 Dès ce moment, Pilate cherchait à le relâcher. Mais les Juifs criaient: Si tu le relâches, tu n'es pas ami de César. Quiconque se fait roi se déclare contre César. "},
	{13, "13 Pilate, ayant entendu ces paroles, amena Jésus dehors; et il s'assit sur le tribunal, au lieu appelé le Pavé, et en hébreu Gabbatha. "},
	{14, "14 C'était la préparation de la Pâque, et environ la sixième heure. Pilate dit aux Juifs: Voici votre roi. "},
	{15, "15 Mais ils s'écrièrent: Ote, ôte, crucifie-le! Pilate leur dit: Crucifierai-je votre roi? Les principaux sacrificateurs répondirent: Nous n'avons de roi que César. "},
	{16, "16 Alors il le leur livra pour être crucifié. Ils prirent donc Jésus, et l'emmenèrent. "},
	{17, "17 Jésus, portant sa croix, arriva au lieu du crâne, qui se nomme en hébreu Golgotha. "},
	{18, "18 C'est là qu'il fut crucifié, et deux autres avec lui, un de chaque côté, et Jésus au milieu. "},
	{19, "19 Pilate fit une inscription, qu'il plaça sur la croix, et qui était ainsi conçue: Jésus de Nazareth, roi des Juifs. "},
	{20, "20 Beaucoup de Juifs lurent cette inscription, parce que le lieu où Jésus fut crucifié était près de la ville: elle était en hébreu, en grec et en latin. "},
	{21, "21 Les principaux sacrificateurs des Juifs dirent à Pilate: N'écris pas: Roi des Juifs. Mais écris qu'il a dit: Je suis roi des Juifs. "},
	{22, "22 Pilate répondit: Ce que j'ai écrit, je l'ai écrit. "},
	{23, "23 Les soldats, après avoir crucifié Jésus, prirent ses vêtements, et ils en firent quatre parts, une part pour chaque soldat. Ils prirent aussi sa tunique, qui était sans couture, d'un seul tissu depuis le haut jusqu'en bas. "},
	{24, "24 (19:23) Et ils dirent entre eux: (19:24) Ne la déchirons pas, mais tirons au sort à qui elle sera. Cela arriva afin que s'accomplît cette parole de l'Écriture: Ils se sont partagé mes vêtements, Et ils ont tiré au sort ma tunique. Voilà ce que firent les soldats. "},
	{25, "25 Près de la croix de Jésus se tenaient sa mère et la soeur de sa mère, Marie, femme de Clopas, et Marie de Magdala. "},
	{26, "26 Jésus, voyant sa mère, et auprès d'elle le disciple qu'il aimait, dit à sa mère: Femme, voilà ton fils. "},
	{27, "27 Puis il dit au disciple: Voilà ta mère. Et, dès ce moment, le disciple la prit chez lui. "},
	{28, "28 Après cela, Jésus, qui savait que tout était déjà consommé, dit, afin que l'Écriture fût accomplie: J'ai soif. "},
	{29, "29 Il y avait là un vase plein de vinaigre. Les soldats en remplirent une éponge, et, l'ayant fixée à une branche d'hysope, ils l'approchèrent de sa bouche. "},
	{30, "30 Quand Jésus eut pris le vinaigre, il dit: Tout est accompli. Et, baissant la tête, il rendit l'esprit. "},
	{31, "31 Dans la crainte que les corps ne restassent sur la croix pendant le sabbat, -car c'était la préparation, et ce jour de sabbat était un grand jour, -les Juifs demandèrent à Pilate qu'on rompît les jambes aux crucifiés, et qu'on les enlevât. "},
	{32, "32 Les soldats vinrent donc, et ils rompirent les jambes au premier, puis à l'autre qui avait été crucifié avec lui. "},
	{33, "33 S'étant approchés de Jésus, et le voyant déjà mort, ils ne lui rompirent pas les jambes; "},
	{34, "34 mais un des soldats lui perça le côté avec une lance, et aussitôt il sortit du sang et de l'eau. "},
	{35, "35 Celui qui l'a vu en a rendu témoignage, et son témoignage est vrai; et il sait qu'il dit vrai, afin que vous croyiez aussi. "},
	{36, "36 Ces choses sont arrivées, afin que l'Écriture fût accomplie: Aucun de ses os ne sera brisé. "},
	{37, "37 Et ailleurs l'Écriture dit encore: Ils verront celui qu'ils ont percé. "},
	{38, "38 Après cela, Joseph d'Arimathée, qui était disciple de Jésus, mais en secret par crainte des Juifs, demanda à Pilate la permission de prendre le corps de Jésus. Et Pilate le permit. Il vint donc, et prit le corps de Jésus. "},
	{39, "39 Nicodème, qui auparavant était allé de nuit vers Jésus, vint aussi, apportant un mélange d'environ cent livres de myrrhe et d'aloès. "},
	{40, "40 Ils prirent donc le corps de Jésus, et l'enveloppèrent de bandes, avec les aromates, comme c'est la coutume d'ensevelir chez les Juifs. "},
	{41, "41 Or, il y avait un jardin dans le lieu où Jésus avait été crucifié, et dans le jardin un sépulcre neuf, où personne encore n'avait été mis. "},
	{42, "42 Ce fut là qu'ils déposèrent Jésus, à cause de la préparation des Juifs, parce que le sépulcre était proche. "},
};
size_t npoems = sizeof poems / sizeof poems[0];size_t i;for (i=0; i < npoems; ++i) {printf("%s\n", poems[i].msg);}
}
static void view20() {
struct fr20 poems[] = {
	{1, "1 Le premier jour de la semaine, Marie de Magdala se rendit au sépulcre dès le matin, comme il faisait encore obscur; et elle vit que la pierre était ôtée du sépulcre. "},
	{2, "2 Elle courut vers Simon Pierre et vers l'autre disciple que Jésus aimait, et leur dit: Ils ont enlevé du sépulcre le Seigneur, et nous ne savons où ils l'ont mis. "},
	{3, "3 Pierre et l'autre disciple sortirent, et allèrent au sépulcre. "},
	{4, "4 Ils couraient tous deux ensemble. Mais l'autre disciple courut plus vite que Pierre, et arriva le premier au sépulcre; "},
	{5, "5 s'étant baissé, il vit les bandes qui étaient à terre, cependant il n'entra pas. "},
	{6, "6 Simon Pierre, qui le suivait, arriva et entra dans le sépulcre; il vit les bandes qui étaient à terre, "},
	{7, "7 et le linge qu'on avait mis sur la tête de Jésus, non pas avec les bandes, mais plié dans un lieu à part. "},
	{8, "8 Alors l'autre disciple, qui était arrivé le premier au sépulcre, entra aussi; et il vit, et il crut. "},
	{9, "9 Car ils ne comprenaient pas encore que, selon l'Écriture, Jésus devait ressusciter des morts. "},
	{10, "10 Et les disciples s'en retournèrent chez eux. "},
	{11, "11 Cependant Marie se tenait dehors près du sépulcre, et pleurait. Comme elle pleurait, elle se baissa pour regarder dans le sépulcre; "},
	{12, "12 et elle vit deux anges vêtus de blanc, assis à la place où avait été couché le corps de Jésus, l'un à la tête, l'autre aux pieds. "},
	{13, "13 Ils lui dirent: Femme, pourquoi pleures-tu? Elle leur répondit: Parce qu'ils ont enlevé mon Seigneur, et je ne sais où ils l'ont mis. "},
	{14, "14 En disant cela, elle se retourna, et elle vit Jésus debout; mais elle ne savait pas que c'était Jésus. "},
	{15, "15 Jésus lui dit: Femme, pourquoi pleures-tu? Qui cherches-tu? Elle, pensant que c'était le jardinier, lui dit: Seigneur, si c'est toi qui l'as emporté, dis-moi où tu l'as mis, et je le prendrai. "},
	{16, "16 Jésus lui dit: Marie! Elle se retourna, et lui dit en hébreu: Rabbouni! c'est-à-dire, Maître! "},
	{17, "17 Jésus lui dit: Ne me touche pas; car je ne suis pas encore monté vers mon Père. Mais va trouver mes frères, et dis-leur que je monte vers mon Père et votre Père, vers mon Dieu et votre Dieu. "},
	{18, "18 Marie de Magdala alla annoncer aux disciples qu'elle avait vu le Seigneur, et qu'il lui avait dit ces choses. "},
	{19, "19 Le soir de ce jour, qui était le premier de la semaine, les portes du lieu où se trouvaient les disciples étant fermées, à cause de la crainte qu'ils avaient des Juifs, Jésus vint, se présenta au milieu d'eux, et leur dit: La paix soit avec vous! "},
	...
	{21, "21 Jésus leur dit de nouveau: La paix soit avec vous! Comme le Père m'a envoyé, moi aussi je vous envoie. "},
	{22, "22 Après ces paroles, il souffla sur eux, et leur dit: Recevez le Saint-Esprit. "},
	{23, "23 Ceux à qui vous pardonnerez les péchés, ils leur seront pardonnés; et ceux à qui vous les retiendrez, ils leur seront retenus. "},
	{24, "24 Thomas, appelé Didyme, l'un des douze, n'était pas avec eux lorsque Jésus vint. "},
	{25, "25 Les autres disciples lui dirent donc: Nous avons vu le Seigneur. Mais il leur dit: Si je ne vois dans ses mains la marque des clous, et si je ne mets mon doigt dans la marque des clous, et si je ne mets ma main dans son côté, je ne croirai point. "},
	{26, "26 Huit jours après, les disciples de Jésus étaient de nouveau dans la maison, et Thomas se trouvait avec eux. Jésus vint, les portes étant fermées, se présenta au milieu d'eux, et dit: La paix soit avec vous! "},
	{27, "27 Puis il dit à Thomas: Avance ici ton doigt, et regarde mes mains; avance aussi ta main, et mets-la dans mon côté; et ne sois pas incrédule, mais crois. "},
	{28, "28 Thomas lui répondit: Mon Seigneur et mon Dieu! "},
	{29, "29 (20:28) Jésus lui dit: (20:29) Parce que tu m'as vu, tu as cru. Heureux ceux qui n'ont pas vu, et qui ont cru! "},
	{30, "30 Jésus a fait encore, en présence de ses disciples, beaucoup d'autres miracles, qui ne sont pas écrits dans ce livre. "},
	{31, "31 Mais ces choses ont été écrites afin que vous croyiez que Jésus est le Christ, le Fils de Dieu, et qu'en croyant vous ayez la vie en son nom. "},
};
size_t npoems = sizeof poems / sizeof poems[0];size_t i;for (i=0; i < npoems; ++i) {printf("%s\n", poems[i].msg);}
}
static void view21() {
struct fr21 poems[] = {
	{1, "1 Après cela, Jésus se montra encore aux disciples, sur les bords de la mer de Tibériade. Et voici de quelle manière il se montra. "},
	{2, "2 Simon Pierre, Thomas, appelé Didyme, Nathanaël, de Cana en Galilée, les fils de Zébédée, et deux autres disciples de Jésus, étaient ensemble. "},
	{3, "3 Simon Pierre leur dit: Je vais pêcher. Ils lui dirent: Nous allons aussi avec toi. Ils sortirent et montèrent dans une barque, et cette nuit-là ils ne prirent rien. "},
	{4, "4 Le matin étant venu, Jésus se trouva sur le rivage; mais les disciples ne savaient pas que c'était Jésus. "},
	{5, "5 Jésus leur dit: Enfants, n'avez-vous rien à manger? Ils lui répondirent: Non. "},
	{6, "6 Il leur dit: Jetez le filet du côté droit de la barque, et vous trouverez. Ils le jetèrent donc, et ils ne pouvaient plus le retirer, à cause de la grande quantité de poissons. "},
	{7, "7 Alors le disciple que Jésus aimait dit à Pierre: C'est le Seigneur! Et Simon Pierre, dès qu'il eut entendu que c'était le Seigneur, mit son vêtement et sa ceinture, car il était nu, et se jeta dans la mer. "},
	{8, "8 Les autres disciples vinrent avec la barque, tirant le filet plein de poissons, car ils n'étaient éloignés de terre que d'environ deux cents coudées. "},
	{9, "9 Lorsqu'ils furent descendus à terre, ils virent là des charbons allumés, du poisson dessus, et du pain. "},
	{10, "10 Jésus leur dit: Apportez des poissons que vous venez de prendre. "},
	{11, "11 Simon Pierre monta dans la barque, et tira à terre le filet plein de cent cinquante-trois grands poissons; et quoiqu'il y en eût tant, le filet ne se rompit point. "},
	{12, "12 Jésus leur dit: Venez, mangez. Et aucun des disciples n'osait lui demander: Qui es-tu? sachant que c'était le Seigneur. "},
	{13, "13 Jésus s'approcha, prit le pain, et leur en donna; il fit de même du poisson. "},
	{14, "14 C'était déjà la troisième fois que Jésus se montrait à ses disciples depuis qu'il était ressuscité des morts. "},
	{15, "15 Après qu'ils eurent mangé, Jésus dit à Simon Pierre: Simon, fils de Jonas, m'aimes-tu plus que ne m'aiment ceux-ci? Il lui répondit: Oui, Seigneur, tu sais que je t'aime. Jésus lui dit: Pais mes agneaux. "},
	{16, "16 Il lui dit une seconde fois: Simon, fils de Jonas, m'aimes-tu? Pierre lui répondit: Oui, Seigneur, tu sais que je t'aime. Jésus lui dit: Pais mes brebis. "},
	{17, "17 Il lui dit pour la troisième fois: Simon, fils de Jonas, m'aimes-tu? Pierre fut attristé de ce qu'il lui avait dit pour la troisième fois: M'aimes-tu? Et il lui répondit: Seigneur, tu sais toutes choses, tu sais que je t'aime. Jésus lui dit: Pais mes brebis. "},
	{18, "18 En vérité, en vérité, je te le dis, quand tu étais plus jeune, tu te ceignais toi-même, et tu allais où tu voulais; mais quand tu seras vieux, tu étendras tes mains, et un autre te ceindra, et te mènera où tu ne voudras pas. "},
	{19, "19 Il dit cela pour indiquer par quelle mort Pierre glorifierait Dieu. Et ayant ainsi parlé, il lui dit: Suis-moi. "},
	{20, "20 Pierre, s'étant retourné, vit venir après eux le disciple que Jésus aimait, celui qui, pendant le souper, s'était penché sur la poitrine de Jésus, et avait dit: Seigneur, qui est celui qui te livre? "},
	{21, "21 En le voyant, Pierre dit à Jésus: Et celui-ci, Seigneur, que lui arrivera-t-il? "},
	{22, "22 Jésus lui dit: Si je veux qu'il demeure jusqu'à ce que je vienne, que t'importe? Toi, suis-moi. "},
	{23, "23 Là-dessus, le bruit courut parmi les frères que ce disciple ne mourrait point. Cependant Jésus n'avait pas dit à Pierre qu'il ne mourrait point; mais: Si je veux qu'il demeure jusqu'à ce que je vienne, que t'importe? "},
	{24, "24 C'est ce disciple qui rend témoignage de ces choses, et qui les a écrites. Et nous savons que son témoignage est vrai. "},
	{25, "25 Jésus a fait encore beaucoup d'autres choses; si on les écrivait en détail, je ne pense pas que le monde même pût contenir les livres qu'on écrirait. "},
};
size_t npoems = sizeof poems / sizeof poems[0];size_t i;for (i=0; i < npoems; ++i) {printf("%s\n", poems[i].msg);}
}
};