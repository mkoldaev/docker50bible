...
struct fr1 poems[] = {
	...
	{6, "6 à la louange de la gloire de sa grâce qu'il nous a accordée en son bien-aimé. "},
	...
	{13, "13 En lui vous aussi, après avoir entendu la parole de la vérité, l'Évangile de votre salut, en lui vous avez cru et vous avez été scellés du Saint-Esprit qui avait été promis, "},
	...
	{22, "22 Il a tout mis sous ses pieds, et il l'a donné pour chef suprême à l'Église, "},
...
struct fr2 poems[] = {
	...
	{11, "11 C'est pourquoi, vous autrefois païens dans la chair, appelés incirconcis par ceux qu'on appelle circoncis et qui le sont en la chair par la main de l'homme, (2:12) souvenez-vous "},
	...
	{15, "15 (2:14) l'inimitié, (2:15) ayant anéanti par sa chair la loi des ordonnances dans ses prescriptions, afin de créer en lui-même avec les deux un seul homme nouveau, en établissant la paix, "},
...
struct fr3 poems[] = {
	...
	{6, "6 Ce mystère, c'est que les païens sont cohéritiers, forment un même corps, et participent à la même promesse en Jésus-Christ par l'Évangile, "},
	...
	{10, "10 afin que les dominations et les autorités dans les lieux célestes connaissent aujourd'hui par l'Église la sagesse infiniment variée de Dieu, "},
	...
	{21, "21 à lui soit la gloire dans l'Église et en Jésus-Christ, dans toutes les générations, aux siècles des siècles! Amen! "},
};
size_t npoems = sizeof poems / sizeof poems[0];size_t i;for (i=0; i < npoems; ++i) {printf("%s\n", poems[i].msg);}
}
static void view4() {
struct fr4 poems[] = {
	...
	{8, "8 C'est pourquoi il est dit: Étant monté en haut, il a emmené des captifs, Et il a fait des dons aux hommes. "},
	...
	{22, "22 (4:21) à vous dépouiller, (4:22) eu égard à votre vie passée, du vieil homme qui se corrompt par les convoitises trompeuses, "},
...
struct fr5 poems[] = {
	...
	{23, "23 car le mari est le chef de la femme, comme Christ est le chef de l'Église, qui est son corps, et dont il est le Sauveur. "},
	{24, "24 Or, de même que l'Église est soumise à Christ, les femmes aussi doivent l'être à leurs maris en toutes choses. "},
	{25, "25 Maris, aimez vos femmes, comme Christ a aimé l'Église, et s'est livré lui-même pour elle, "},
	{26, "26 afin de la sanctifier par la parole, après l'avoir purifiée par le baptême d'eau, "},
	{27, "27 afin de faire paraître devant lui cette Église glorieuse, sans tache, ni ride, ni rien de semblable, mais sainte et irrépréhensible. "},
	...
	{29, "29 Car jamais personne n'a haï sa propre chair; mais il la nourrit et en prend soin, comme Christ le fait pour l'Église, "},
	...
	{32, "32 Ce mystère est grand; je dis cela par rapport à Christ et à l'Église. "},
...
struct fr6 poems[] = {
	...
	{15, "15 mettez pour chaussure à vos pieds le zèle que donne l'Évangile de paix; "},
	...
	{19, "19 Priez pour moi, afin qu'il me soit donné, quand j'ouvre la bouche, de faire connaître hardiment et librement le mystère de l'Évangile, "},
