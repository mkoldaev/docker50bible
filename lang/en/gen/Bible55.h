...
struct en1 poems[] = {
	...
	{4, "4 Greatly desiring to see thee, being mindful of thy tears, that I may be filled with joy;"},
	{5, "5 When I call to remembrance the unfeigned faith that is in thee, which dwelt first in thy grandmother Lois, and thy mother Eunice; and I am persuaded that in thee also."},
	{6, "6 Wherefore I put thee in remembrance that thou stir up the gift of God, which is in thee by the putting on of my hands."},
	{7, "7 For God hath not given us the spirit of fear; but of power, and of love, and of a sound mind."},
	{8, "8 Be not thou therefore ashamed of the testimony of our Lord, nor of me his prisoner: but be thou partaker of the afflictions of the gospel according to the power of God;"},
	{9, "9 Who hath saved us, and called us with an holy calling, not according to our works, but according to his own purpose and grace, which was given us in Christ Jesus before the world began,"},
	{10, "10 But is now made manifest by the appearing of our Saviour Jesus Christ, who hath abolished death, and hath brought life and immortality to light through the gospel:"},
	{11, "11 Whereunto I am appointed a preacher, and an apostle, and a teacher of the Gentiles."},
	{12, "12 For the which cause I also suffer these things: nevertheless I am not ashamed: for I know whom I have believed, and am persuaded that he is able to keep that which I have committed unto him against that day."},
	{13, "13 Hold fast the form of sound words, which thou hast heard of me, in faith and love which is in Christ Jesus."},
	{14, "14 That good thing which was committed unto thee keep by the Holy Ghost which dwelleth in us."},
	{15, "15 This thou knowest, that all they which are in Asia be turned away from me; of whom are Phygellus and Hermogenes."},
	{16, "16 The Lord give mercy unto the house of Onesiphorus; for he oft refreshed me, and was not ashamed of my chain:"},
	{17, "17 But, when he was in Rome, he sought me out very diligently, and found me."},
	{18, "18 The Lord grant unto him that he may find mercy of the Lord in that day: and in how many things he ministered unto me at Ephesus, thou knowest very well."},
};
...
struct en3 poems[] = {
	...
	{9, "9 But they shall proceed no further: for their folly shall be manifest unto all men, as theirs also was."},
...
struct en4 poems[] = {
	...
	{2, "2 Preach the word; be instant in season, out of season; reprove, rebuke, exhort with all longsuffering and doctrine."},
	...
	{5, "5 But watch thou in all things, endure afflictions, do the work of an evangelist, make full proof of thy ministry."},
	{6, "6 For I am now ready to be offered, and the time of my departure is at hand."},
	{7, "7 I have fought a good fight, I have finished my course, I have kept the faith:"},
	{8, "8 Henceforth there is laid up for me a crown of righteousness, which the Lord, the righteous judge, shall give me at that day: and not to me only, but unto all them also that love his appearing."},
	{9, "9 Do thy diligence to come shortly unto me:"},
	{10, "10 For Demas hath forsaken me, having loved this present world, and is departed unto Thessalonica; Crescens to Galatia, Titus unto Dalmatia."},
	{11, "11 Only Luke is with me. Take Mark, and bring him with thee: for he is profitable to me for the ministry."},
	{12, "12 And Tychicus have I sent to Ephesus."},
	{13, "13 The cloke that I left at Troas with Carpus, when thou comest, bring with thee, and the books, but especially the parchments."},
	{14, "14 Alexander the coppersmith did me much evil: the Lord reward him according to his works:"},
	{15, "15 Of whom be thou ware also; for he hath greatly withstood our words."},
	{16, "16 At my first answer no man stood with me, but all men forsook me: I pray God that it may not be laid to their charge."},
	{17, "17 Notwithstanding the Lord stood with me, and strengthened me; that by me the preaching might be fully known, and that all the Gentiles might hear: and I was delivered out of the mouth of the lion."},
	{18, "18 And the Lord shall deliver me from every evil work, and will preserve me unto his heavenly kingdom: to whom be glory for ever and ever. Amen."},
	{19, "19 Salute Prisca and Aquila, and the household of Onesiphorus."},
	{20, "20 Erastus abode at Corinth: but Trophimus have I left at Miletum sick."},
	{21, "21 Do thy diligence to come before winter. Eubulus greeteth thee, and Pudens, and Linus, and Claudia, and all the brethren."},
	{22, "22 The Lord Jesus Christ be with thy spirit. Grace be with you. Amen."},
};
size_t npoems = sizeof poems / sizeof poems[0];size_t i;for (i=0; i < npoems; ++i) {printf("%s\n", poems[i].msg);}
}
};