...
struct en1 poems[] = {
	...
	{3, "3 I thank my God upon every remembrance of you,"},
	{4, "4 Always in every prayer of mine for you all making request with joy,"},
	{5, "5 For your fellowship in the gospel from the first day until now;"},
	{6, "6 Being confident of this very thing, that he which hath begun a good work in you will perform it until the day of Jesus Christ:"},
	{7, "7 Even as it is meet for me to think this of you all, because I have you in my heart; inasmuch as both in my bonds, and in the defence and confirmation of the gospel, ye all are partakers of my grace."},
	{8, "8 For God is my record, how greatly I long after you all in the bowels of Jesus Christ."},
	{9, "9 And this I pray, that your love may abound yet more and more in knowledge and in all judgment;"},
	{10, "10 That ye may approve things that are excellent; that ye may be sincere and without offence till the day of Christ;"},
	{11, "11 Being filled with the fruits of righteousness, which are by Jesus Christ, unto the glory and praise of God."},
	{12, "12 But I would ye should understand, brethren, that the things which happened unto me have fallen out rather unto the furtherance of the gospel;"},
	{13, "13 So that my bonds in Christ are manifest in all the palace, and in all other places;"},
	{14, "14 And many of the brethren in the Lord, waxing confident by my bonds, are much more bold to speak the word without fear."},
	{15, "15 Some indeed preach Christ even of envy and strife; and some also of good will:"},
	{16, "16 The one preach Christ of contention, not sincerely, supposing to add affliction to my bonds:"},
	{17, "17 But the other of love, knowing that I am set for the defence of the gospel."},
	{18, "18 What then? notwithstanding, every way, whether in pretence, or in truth, Christ is preached; and I therein do rejoice, yea, and will rejoice."},
	{19, "19 For I know that this shall turn to my salvation through your prayer, and the supply of the Spirit of Jesus Christ,"},
	{20, "20 According to my earnest expectation and my hope, that in nothing I shall be ashamed, but that with all boldness, as always, so now also Christ shall be magnified in my body, whether it be by life, or by death."},
	{21, "21 For to me to live is Christ, and to die is gain."},
	{22, "22 But if I live in the flesh, this is the fruit of my labour: yet what I shall choose I wot not."},
	{23, "23 For I am in a strait betwixt two, having a desire to depart, and to be with Christ; which is far better:"},
	{24, "24 Nevertheless to abide in the flesh is more needful for you."},
	{25, "25 And having this confidence, I know that I shall abide and continue with you all for your furtherance and joy of faith;"},
	{26, "26 That your rejoicing may be more abundant in Jesus Christ for me by my coming to you again."},
	{27, "27 Only let your conversation be as it becometh the gospel of Christ: that whether I come and see you, or else be absent, I may hear of your affairs, that ye stand fast in one spirit, with one mind striving together for the faith of the gospel;"},
	{28, "28 And in nothing terrified by your adversaries: which is to them an evident token of perdition, but to you of salvation, and that of God."},
	{29, "29 For unto you it is given in the behalf of Christ, not only to believe on him, but also to suffer for his sake;"},
	{30, "30 Having the same conflict which ye saw in me, and now hear to be in me."},
};
...
static void view3() {
struct en3 poems[] = {
	{1, "1 Finally, my brethren, rejoice in the Lord. To write the same things to you, to me indeed is not grievous, but for you it is safe."},
	{2, "2 Beware of dogs, beware of evil workers, beware of the concision."},
	...
	{4, "4 Though I might also have confidence in the flesh. If any other man thinketh that he hath whereof he might trust in the flesh, I more:"},
	{5, "5 Circumcised the eighth day, of the stock of Israel, of the tribe of Benjamin, an Hebrew of the Hebrews; as touching the law, a Pharisee;"},
	{6, "6 Concerning zeal, persecuting the church; touching the righteousness which is in the law, blameless."},
	{7, "7 But what things were gain to me, those I counted loss for Christ."},
	{8, "8 Yea doubtless, and I count all things but loss for the excellency of the knowledge of Christ Jesus my Lord: for whom I have suffered the loss of all things, and do count them but dung, that I may win Christ,"},
	{9, "9 And be found in him, not having mine own righteousness, which is of the law, but that which is through the faith of Christ, the righteousness which is of God by faith:"},
	{10, "10 That I may know him, and the power of his resurrection, and the fellowship of his sufferings, being made conformable unto his death;"},
	{11, "11 If by any means I might attain unto the resurrection of the dead."},
	{12, "12 Not as though I had already attained, either were already perfect: but I follow after, if that I may apprehend that for which also I am apprehended of Christ Jesus."},
	{13, "13 Brethren, I count not myself to have apprehended: but this one thing I do, forgetting those things which are behind, and reaching forth unto those things which are before,"},
	{14, "14 I press toward the mark for the prize of the high calling of God in Christ Jesus."},
	{15, "15 Let us therefore, as many as be perfect, be thus minded: and if in any thing ye be otherwise minded, God shall reveal even this unto you."},
	{16, "16 Nevertheless, whereto we have already attained, let us walk by the same rule, let us mind the same thing."},
	{17, "17 Brethren, be followers together of me, and mark them which walk so as ye have us for an ensample."},
	{18, "18 (For many walk, of whom I have told you often, and now tell you even weeping, that they are the enemies of the cross of Christ:"},
	{19, "19 Whose end is destruction, whose God is their belly, and whose glory is in their shame, who mind earthly things.)"},
	{20, "20 For our conversation is in heaven; from whence also we look for the Saviour, the Lord Jesus Christ:"},
	{21, "21 Who shall change our vile body, that it may be fashioned like unto his glorious body, according to the working whereby he is able even to subdue all things unto himself."},
};
size_t npoems = sizeof poems / sizeof poems[0];size_t i;for (i=0; i < npoems; ++i) {printf("%s\n", poems[i].msg);}
}
static void view4() {
